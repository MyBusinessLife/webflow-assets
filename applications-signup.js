(() => {
  ...
  window.Webflow.push(async function () {
    ...
    normalizeSignupFormLayout({
      ...
      submitBtn,
      fields: [
        { control: companyEl, label: "Entreprise" },
        { control: nameEl, label: "Nom complet" },
        { control: emailEl, label: "Email professionnel" },
        { control: phoneEl, label: "Telephone (optionnel)" },
        { control: cityEl, label: "Ville (optionnel)" },
        { control: pwdEl, label: "Mot de passe" },
        { control: confirmField, label: "Confirmer le mot de passe" },
      ],
    });
