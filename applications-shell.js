(() => {
  ...
  window.Webflow.push(async function () {
    ...
    const FALLBACK_ROUTES = {
      ...
      "admin-purchases": `${CONFIG.APP_ROOT}/purchases`,
      "admin-loyalty": `${CONFIG.APP_ROOT}/loyalty`,
    ...
    const ICONS = {
      ...
      purchases: `<svg class="mbl-nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 4h6"/><path d="M9 4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2"/><path d="M9 10h6"/><path d="M9 14h6"/><path d="M9 18h4"/></svg>`,
      loyalty: `<svg class="mbl-nav__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21l-8-5-8 5V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v16z"/><path d="M12 7l1.2 2.6 2.8.3-2.1 1.9.6 2.8L12 13.9 9.5 14.6l.6-2.8L8 9.9l2.8-.3L12 7z"/></svg>`,
        ...
        },
        {
          ...
          entries: [
            ...
            },
            {
              key: "admin-loyalty",
              label: "Fidélité",
              href: routeFor("admin-loyalty"),
              icon: ICONS.loyalty,
              perm: PERMS.loyalty,
              roles: [],
              requires: ["billing", "loyalty"],
            },
            {
              key: "devis-list",
              label: "Devis",
        ...
        },
        {
          ...
          entries: [
            ...
            },
            {
              key: "admin-purchases",
              label: "Achats",
              href: routeFor("admin-purchases"),
              icon: ICONS.purchases,
              perm: PERMS.purchases,
              roles: [],
              requires: ["purchases"],
            },
          ],
